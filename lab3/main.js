...
function displayResults( res ) {
    ...
    let degreeInfo = document.getElementById('degree');
    degreeInfo.innerText = `${Math.floor(res.main.temp_min)}°C / ${Math.floor(res.main.temp_max)}°C`;
}
...
window.onload = getResults('New Delhi');